            ...
            <div id="review">
                <div id="review-title">
                    <strong><span>ENABLE #<?php echo $enable_info['enable_id'] ?>
                            has been submitted.</span></strong><br/>
                ...
                <div id="item-properties">
                    ...
                    <strong>artwork |&nbsp;</strong><a target="_blank"
                                                       href="<?php echo DIR . $enable_info['image_filepath'] ?>">Click
                        Here to Redirect</a><br>
                </div>
                <br style="clear:both"/>
                ...
                <div id="review-close">
                    <br/>
                    <hr style="border: solid 1px #f2b139; margin: 7px;">
                    <p>The administrators will now process your request. You should hear back within 48 hours via
                        email.</p>
                </div>
            </div>
        </div>
