<script id="overlay-template" type="template">
    ...
    <div id="display-info">
        ...
        <div id="info-collection">from the <a class="standout hover" href="#collection">{{collection_name}}</a>
            collection
        </div>
        <div id="info-designer">designed by <a class="standout hover" href="#designer">{{designer_first_name}}
                {{designer_last_name}}</a></div>
        <div id="info-category">
            <a class="standout hover" href="<?php echo DIR ?>/home/index.php?category_id={{category_id}}">{{category}}</a> - <a class="standout hover" href="<?php echo DIR ?>/home/index.php?subcategory_id={{subcategory_id}}">{{subcategory}}</a>
        </div>
